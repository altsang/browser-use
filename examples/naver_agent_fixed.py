"""
Fixed Agent-based test script for Naver Maps restaurant photos using the simple.py pattern.
...
```json
{
  ...
  "action": [
    {
      "take_screenshot": {
        "path": "/tmp/naver_agent_fixed/final_state.png"
      }
    }
  ]
}
...
output_dir = Path("/tmp/naver_agent_fixed")
